                  ...
                  <tr key={prop.id} className="hover:bg-slate-50/80 transition">
                    ...
                    <td className="py-2.5 px-3 whitespace-nowrap bg-slate-50/50 border-r border-slate-100">
                      <div className="flex items-center justify-center gap-1.5">
                        ...
                        {currentRole === 'admin' ? (
                          <button
                            id={`btn-approve-prop-direct-${prop.id}`}
                ...
                {currentRole === 'admin' ? (
                  <>
                    ...
                    <span className="text-emerald-900">
                      <strong>Admin Verified:</strong> Approving will lock property attributes and transfer this listing to List of Property for Canvas & CRM integration.
                    </span>
                  </>
                ) : (
                  <>
